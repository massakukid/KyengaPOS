...
End Enum
Module Draw
    Public Function RoundRectm(ByVal Rectangle As Rectangle, ByVal Curve As Integer) As GraphicsPath
        ...
        Return P
    End Function
    Public Function RoundRectm(ByVal X As Integer, ByVal Y As Integer, ByVal Width As Integer, ByVal Height As Integer, ByVal Curve As Integer) As GraphicsPath
    ...
    Public Sub InnerGlowRounded(ByVal G As Graphics, ByVal Rectangle As Rectangle, ByVal Degree As Integer, ByVal Colors As Color())
        ...
        Dim AddOne As Integer = 0
        For Each c In Colors
            G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(c.R, c.B, c.G))), Draw.RoundRectm(Rectangle.X + AddOne, Rectangle.Y + AddOne, Rectangle.Width - SubtractTwo, Rectangle.Height - SubtractTwo, Degree))
            SubtractTwo += 2
            AddOne += 1
        Next
    End Sub
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(40, 40, 40)), Draw.RoundRectm(ClientRectangle, 3))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(15, 15, 15))), Draw.RoundRectm(ClientRectangle, 3))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(55, 55, 55))), Draw.RoundRectm(New Rectangle(1, 1, Width - 3, Height - 3), 3))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(bodyGrad, Draw.RoundRectm(onoffRect, 4))
        G.DrawPath(New Pen(Color.FromArgb(15, 15, 15)), Draw.RoundRectm(onoffRect, 4))
        G.DrawPath(New Pen(Color.FromArgb(50, 50, 50)), Draw.RoundRectm(New Rectangle(1, 1, Width - 3, Height - 3), 4))

        If Checked Then
            G.FillPath(New SolidBrush(Color.FromArgb(80, Color.Green)), Draw.RoundRectm(New Rectangle(4, 2, 25, Height - 5), 4))
            G.FillPath(New SolidBrush(Color.FromArgb(35, 35, 35)), Draw.RoundRectm(New Rectangle(2, 2, 25, Height - 5), 4))
            G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), Draw.RoundRectm(New Rectangle(2, 2, 25, Height - 5), 4))
            Select Case State
                Case MouseState.None
            ...
            End Select
        Else
            G.FillPath(New SolidBrush(Color.FromArgb(60, Color.Red)), Draw.RoundRectm(New Rectangle((Width / 2) - 7, 2, Width - 25, Height - 5), 4))
            G.FillPath(New SolidBrush(Color.FromArgb(35, 35, 35)), Draw.RoundRectm(New Rectangle((Width / 2) - 5, 2, Width - 23, Height - 5), 4))
            G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(20, 20, 20))), Draw.RoundRectm(New Rectangle((Width / 2) - 5, 2, Width - 23, Height - 5), 4))
            Select Case State
                Case MouseState.None
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(New SolidBrush(Color.FromArgb(50, 50, 50)), Draw.RoundRectm(ClientRectangle, 3))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim c As Color() = New Color() {Color.FromArgb(20, 20, 20), Color.FromArgb(40, 40, 40), Color.FromArgb(45, 45, 45), Color.FromArgb(46, 46, 46), Color.FromArgb(47, 47, 47), Color.FromArgb(48, 48, 48), Color.FromArgb(49, 49, 49), Color.FromArgb(50, 50, 50)}
        G.FillPath(New SolidBrush(Color.FromArgb(50, 50, 50)), Draw.RoundRectm(New Rectangle(0, 0, Width - 1, Height - 1), 3))
        Draw.InnerGlowRounded(G, ClientRectangle, 3, c)

        '//// Bar Fill
        If Not intValue = 0 Then
            G.FillPath(New LinearGradientBrush(New Rectangle(1, 1, intValue, Height - 3), Color.FromArgb(30, 30, 30), Color.FromArgb(35, 35, 35), 90S), Draw.RoundRectm(New Rectangle(1, 1, intValue, Height - 3), 2))
            G.DrawPath(New Pen(Color.FromArgb(45, 45, 45)), Draw.RoundRectm(New Rectangle(1, 1, intValue, Height - 3), 2))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.FillPath(bodyGradNone, Draw.RoundRectm(New Rectangle(bodyGradNone.Rectangle.X, bodyGradNone.Rectangle.Y, bodyGradNone.Rectangle.Width, bodyGradNone.Rectangle.Height), 3))
        ...
        G.DrawPath(New Pen(bodyInBorderNone), Draw.RoundRectm(New Rectangle(1, 1, Width - 3, Height - 4), 3))
        G.DrawPath(New Pen(Color.FromArgb(20, 20, 20)), Draw.RoundRectm(New Rectangle(0, 0, Width - 1, Height - 1), 3)) 'Outer Line
        G.DrawPath(New Pen(Color.FromArgb(55, 55, 55)), Draw.RoundRectm(New Rectangle(1, 1, Width - 3, Height - 3), 3)) 'Inner Line
