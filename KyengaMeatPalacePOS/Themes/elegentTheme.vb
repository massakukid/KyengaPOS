...
#Region "Functions"
    ...
    Public Function RoundRect8(ByVal x!, ByVal y!, ByVal w!, ByVal h!, Optional ByVal r! = 0.3, Optional ByVal TL As Boolean = True, Optional ByVal TR As Boolean = True, Optional ByVal BR As Boolean = True, Optional ByVal BL As Boolean = True) As GraphicsPath
        Dim d! = Math.Min(w, h) * r, xw = x + w, yh = y + h
        RoundRect8 = New GraphicsPath
...
#Region "Declarations"
    ...
    Private _ControlBoxColour As Color = Color.DodgerBlue
    Private _ControlBaseColour As Color = Color.DodgerBlue
    Private _TopStripBorderColour As Color = Color.DodgerBlue
    Private _TopStripColour As Color = Color.DodgerBlue
    Private _BaseColour As Color = Color.DodgerBlue
    Private _BorderColour As Color = Color.DodgerBlue
    Private _ControlBoxButtonSplitColour As Color = Color.DodgerBlue
    Private _IconColour As Color = Color.DodgerBlue
...
#Region "Draw Control"
    ...
    Protected Overrides Sub OnCreateControl()
        ...
        ParentForm.TransparencyKey = Color.DodgerBlue
...
#Region "Declarations"
    Private _BaseColour As Color = Color.FromArgb(50, 50, 50)
    Private _BorderColour As Color = Color.DodgerBlue
    Private _LineColour As Color = Color.DodgerBlue
    Private _TextColour As Color = Color.DodgerBlue
    Private _LeftPolygonColour As Color = Color.DodgerBlue
...
#Region "Declarations"
    ...
    Private _HeaderColour As Color = Color.FromArgb(50, 50, 50)
...
#Region "Properties"
    ...
    Public Property AmountOfString As AmountOfStrings
        ...
        End Get
        Set(ByVal value As AmountOfStrings)
...
#Region "Declarations"
    Private _PressedTabColour As Color = Color.FromArgb(50, 50, 50)
    Private _HoverColour As Color = Color.FromArgb(50, 50, 50)
    Private _NormalColour As Color = Color.FromArgb(50, 50, 50)
    Private _BorderColour As Color = Color.DodgerBlue
    Private _TextColour As Color = Color.White
