...
Module Drawing
    ...
    Public Function RoundRecta(ByVal rect As Rectangle, ByVal slope As Integer) As GraphicsPath
...
Class ascThemeContainer
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim mainPath As GraphicsPath = RoundRecta(mainRect, slope)
        G.FillPath(New SolidBrush(BackColor), mainPath)
        G.DrawPath(New Pen(Color.FromArgb(30, 35, 45)), mainPath)
        G.FillPath(New SolidBrush(Color.FromArgb(30, 30, 40)), RoundRecta(New Rectangle(0, 0, Width - 1, moveHeight - slope), slope))
...
Class ascProgressBar
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If barRect.Width > 0 Then
            ...
            G.FillPath(barHorizontal, RoundRecta(barRect, slope))
            ...
            G.FillPath(barVertical, RoundRecta(barRect, slope))
        End If

        If _Value > 0 Then
            Dim bubbleRect As New Rectangle(barRect.Width - 3, 0, midY * 2 - 3, midY * 2)
            Dim bubblePath As GraphicsPath = RoundRecta(bubbleRect, midY)
