...
Class NSRandomPool
    ...
    Private Sub HandleDraw(ByVal e As MouseEventArgs)
...
Class NSKeyboard
    ...
    Private Sub DrawArrow(ByVal color As Color, ByVal rx As Integer, ByVal ry As Integer)
...
Class NSPaginator
    ...
    Private Sub DrawBox(ByVal x As Integer, ByVal index As Integer, ByVal leftEllipse As Boolean, ByVal rightEllipse As Boolean)
